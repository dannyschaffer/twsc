...
<style>
            ...
            <div class="steps-grid" style="grid-template-columns: repeat(auto-fit, minmax(300px, 1fr));">
                ...
                <div class="step-card"
                    ...
                    <p style="color: rgba(255, 255, 255, 0.8);">You operate in high-stakes environments. You need to
                        protect your longevity and execute without hesitation. <strong
                            style="color: #fff;">Goal:</strong> Peak performance,
    ...
    <section class="section section-dark">
        <div class="container">
            ...
            <p class="section-intro">This isn't a personality quiz. It's an instrument that measures your judgment, was
                nominated for a Nobel Prize, and has been built on the profiles of elite leaders.</p>
