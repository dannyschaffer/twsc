        ...
        <div class="container">
            ...
            <div class="credentials-clean">
                ...
                <div class="cred-item-clean">
                    ...
                    <p>Learned from the top 50 change-makers and industry titans transforming the financial industry.
                    </p>
                </div>
                <div class="cred-item-clean">
                    <h3>Battle Tested</h3>
    ...
    <section class="section" style="background: #f8f9fa; text-align: center;">
        <div class="container" style="max-width: 800px;">
            ...
            <div style="margin-top: 2rem;">
                <a href="<?php echo site_url('/book'); ?>" class="btn-primary" style="margin: 0 1rem;">Book a Consultation</a>
            </div>
        </div>
    </section>
